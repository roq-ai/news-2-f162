...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'administrator', 'editor', 'translator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'News', path: '/news', entity: 'news', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    {
      name: 'Translations',
      path: '/translations',
      entity: 'translation',
    ...
    { name: 'Urls', path: '/urls', entity: 'url', service: AccessServiceEnum.PROJECT, icon: FiLink },
    {
